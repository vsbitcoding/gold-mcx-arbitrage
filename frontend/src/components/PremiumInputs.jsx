...
const DEFAULTS = { cost: 5, duty: 1854062, convBank: 32.12, convAdani: 31.99, fxAdj: 0.01, prmGst: "" };
// convBank -> "999" (32.12) ; convAdani -> "995" (31.99)
// prmGst -> "Premium with GST" the client types (e.g. 3225); rate = Gold big Ask + prmGst
//           (client sheet formula =G15+D9). Blank -> shows "—".
...
export default function PremiumInputs() {
  ...
  // "Premium with GST" (manual) + Gold big Ask → final rate (client formula =G15+D9).
  ...
  return (
    <div className="pv-page">
      ...
      <div className="pv-table">
        ...
        <div className="pv-row pv-prem">
          <span className="pv-param">Gold Ask + PRM GST{goldAsk != null && <span className="pv-mut"> (Ask {num(goldAsk, 0)})</span>}</span>
