...
from app.routes import activity as activity_route, auth, calculator, config as config_route, control, feed, history, ladders, options as options_route, pairs, positions, public_v1, ws as ws_route
