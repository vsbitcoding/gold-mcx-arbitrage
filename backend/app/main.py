...
from app.routes import auth, bullion as bullion_route, calculator, feed, metals as metals_route, options as options_route, othercomm as othercomm_route, pairs, price as price_route, public_v1, signals as signals_route, ws as ws_route
